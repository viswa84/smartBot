    ...
    <div>
      <Box>
          ...
          <Box width="40%" p="10px " pl={"20px"}>
            <Box>
              <Image
                ml={"32%"}
                w={"100px"}
                src="https://www.smatbot.com/img/Instagram/Insta%20Multi%20Logos.png"
              />
            </Box>
            <br />
            ...
            <Box mt={"40px"}>
              <Image
                ml={"55%"}
                w={"40px"}
                src="https://www.smatbot.com/img/Instagram/Love.svg"
              />
            </Box>
          </Box>
          <Box>
        ...
        >
          ...
          <WhatsImage
            width="400px"
            src="https://www.smatbot.com/img/Instagram/live%20chat.png"
          />
        </HStack>
        <HStack
          mt={"100px"}
        ...
        >
          <WhatsImage src="https://www.smatbot.com/img/Instagram/lead%20gen.png" />
